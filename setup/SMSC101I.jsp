...
<script>
	$(document).ready(function(){
		function ContextBtn(){
			//table tr 추가
			$(".btn_contextmenu .btn_add").on("click",function(){
				$(this).parent().parent().find('tbody:last').append(
					'<tr>' +
					'	<td class="algC open_menu"> &nbsp; </td>' +
					'	<td> </td>' +
					'	<td> </td>' +
					'	<td> </td>' +
					'</tr>'
			...
			//table tr 삭제
			$(".btn_contextmenu .btn_del").on("click",function(){
				console.log("btn_del");
				$(this).parent().parent().find('tbody tr:last').remove();
			});
		}
		ContextBtn();
	});
				...
				<li>
					...
					<div class="tbl">
						<table>
							...
							<tbody>
								<tr>
									<td class="algC open_menu">01</td> <!-- 20190201 클래스명 추가 -->
									<td>
